...
exports.createSupplyChainRoutes = createSupplyChainRoutes;
const express_1 = require("express");
function createSupplyChainRoutes(scModule, db) {
        ...
        try {
         ...
         ORDER BY created_at_epoch DESC`);
            const products = rows.map((r) => {
                const provenance = db.query('SELECT * FROM provenance_events WHERE trust_object_id = ? ORDER BY timestamp ASC', [r.trust_object_id]);
                return {
