export type TrustObjectType = 'CREDENTIAL' | 'PRODUCT' | 'EVIDENCE' | 'DEVICE' | 'DOCUMENT' | 'IDENTITY' | 'TRANSACTION';
export type TrustObjectStatus = 'ACTIVE' | 'REVOKED' | 'EXPIRED' | 'TAMPERED';
