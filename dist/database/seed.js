...
async function seedDatabase(clean = true) {
    ...
    const orgs = [
        { sector: 'edu', id: 'delhi-tech-univ', name: 'Delhi Technological University', type: 'UNIVERSITY' },
        { sector: 'sc', id: 'bharat-pharma', name: 'Bharat Pharma Laboratories Ltd', type: 'MANUFACTURER' },
        { sector: 'sc', id: 'apex-logistics', name: 'Apex Cold-Chain Logistics', type: 'DISTRIBUTOR' },
        { sector: 'sc', id: 'delhi-central-hub', name: 'Delhi Central Distribution Warehouse', type: 'DISTRIBUTOR' },
        { sector: 'sc', id: 'medlife-retail', name: 'MedLife Pharmacy Network', type: 'DISTRIBUTOR' },
        { sector: 'legal', id: 'delhi-forensics', name: 'Central Forensic Science Laboratory (CFSL)', type: 'LAW_ENFORCEMENT' },
        { sector: 'legal', id: 'delhi-high-court', name: 'High Court Judicial Registry', type: 'GOVERNMENT' },
    ...
    for (const org of orgs) {
       ...
       VALUES (?, ?, ?, ?, ?, ?, 'VERIFIED')`, ['ORG-' + org.id, org.name, org.type, 'IN-DL', did, keyPair.publicKey]);
        ...
        db.run(`INSERT OR REPLACE INTO users (id, organization_id, email, password_hash, display_name, user_type, did, public_key, encrypted_private_key)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`, [
            'USR-' + org.id,
            'ORG-' + org.id,
            `${org.id}@trustgrid.gov.in`,
            crypto_service_js_1.CryptoService.sha256('TrustGrid2026!'),
            org.name,
            'ISSUER',
            did,
            keyPair.publicKey,
    ...
    const individuals = [
        { sector: 'usr', id: 'rahul-sharma', name: 'Rahul Sharma', email: 'rahul.sharma@student.dtu.ac.in', role: 'STUDENT' },
        { sector: 'usr', id: 'priya-patel', name: 'Priya Patel', email: 'priya.patel@student.dtu.ac.in', role: 'STUDENT' },
        { sector: 'usr', id: 'arun-kumar', name: 'Arun Kumar', email: 'arun.kumar@student.dtu.ac.in', role: 'STUDENT' },
        { sector: 'legal', id: 'inspector-singh', name: 'Inspector Rajesh Singh', email: 'r.singh@police.gov.in', role: 'INVESTIGATOR' },
        { sector: 'sec', id: 'ciso-admin', name: 'Vikram Mehta (Chief InfoSec Officer)', email: 'ciso@cert.gov.in', role: 'SECURITY_ADMIN' },
    ...
    db.run(`INSERT OR REPLACE INTO provenance_events 
